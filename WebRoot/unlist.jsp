<%@ page language="java" import="java.util.*,vo.*,constinfo.*" pageEncoding="UTF-8"%>
					...
					<h3>未审批请假单</h3>
               	  <table cellpadding="0" cellspacing="0">
                  			<tr height="30" valign="middle">
                                ...
                                <th height="30" width="13%" align="center">姓名</th>
							...
							<tr>
                                ...
                                <td align="center"><s:property value="state"/></td>
                                 <!--<td class="action">                          
                                	<a href="reply1.action?id=<s:property value="id"/> class="view">Agree</a>
                                	<a href="reply2.action?id=<s:property value="id"/> class="edit">Disagree</a> 
                                </td>-->
                              	<td align="center">
                                	<form action="replyagree.action" method="post">
                                		<input type="hidden" name="startdate" value="<s:property value="startdate"/>">
										<input type="hidden" name="userid" value="<s:property value="userid"/>">					
										<input type="submit" value="<%=AgreeInfo.ASK_AGREE%>">
									</form><form action="replydisagree.action" method="post">
										<input type="hidden" name="startdate" value="<s:property value="startdate"/>">
										<input type="hidden" name="userid" value="<s:property value="userid"/>">					
										<input type="submit" value="<%=AgreeInfo.ASK_DISAGREE%>">
									</form> 
								</td>  
                            </tr>  
                            </s:iterator>                       
